...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("persistence_months", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "ix_scoresnapshotrecord_entity_id", "scoresnapshotrecord", ["entity_id"]
    )
    ...
    op.create_index(
        "ix_scoredriverrecord_snapshot_id", "scoredriverrecord", ["snapshot_id"]
    )
    op.create_table(
        "alertrecord",
        sa.Column("id", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("assumptions_json", sa.String(), nullable=False),
        sa.Column("status", sa.String(), nullable=False),
    ...
    op.create_index(
        "ix_scenarioprojection_scenario_id", "scenarioprojection", ["scenario_id"]
    )
    op.create_table(
        "recommendedaction",
        sa.Column("id", sa.String(), nullable=False),
    ...
    op.create_index(
        "ix_recommendedaction_entity_id", "recommendedaction", ["entity_id"]
    )
    ...
    op.create_index(
        "ix_macroobservation_available_at", "macroobservation", ["available_at"]
    )
